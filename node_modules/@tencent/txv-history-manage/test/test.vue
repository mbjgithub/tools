 ...
 <body>
  <div id="app">
   <div class="explain">
    ...
    <li>time  当前观看的时间</li>
	<li>dur   视频总时间</li>
	<li>episode    当前观看到的集数</li>
	<li>ispay    是否是付费视频</li><br/>
	<li>keyid    是cid_vid组合</li>
	<li>date      用户什么时间点看的时间</li>
	<li>serverDate   服务器的更新时间,用于和本地更新时间比较，判断要不要上报</li>
	<li>hd          清晰度</li>
	<li>typeid    视频大分类</li>
   </div>
   <div class="header">
    cid_vid:<input type="text" name="" v-model="cid_vid">
    cid:<input type="text" name="" v-model="cid">
    vid:<input type="text" name="" v-model="vid">
    time:<input type="text" name="" v-model="time">
    cur:<input type="text" name="" v-model="cur">
    pn:<input type="text" name="" v-model="pn">
   </div>
   <div class="main">
    <div class="btn">
     <button v-on:click="get($event)">get</button>
     <button v-on:click="getSync($event)">getSync</button>
     <button v-on:click="set">set</button>
    </div>
    <div class="data">
     <div class="left">
      <ol >
       <li v-for="item in left_list">
        {{item}}
       </li>
      </ol>
     </div>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var historyManage = __webpack_require__(1)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fns = __webpack_require__(2)
	var jsonp = __webpack_require__(7)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fns = __webpack_require__(2)
	var TURL = __webpack_require__(8)
	var _ns = '_jsonp'
...
/***/ (function(module, exports) {
	...
	var Storage = {
	  ...
	  support: (function () {
	    return typeof window.localStorage !== 'undefined' && (!!localStorage.getItem);
	  })(),
